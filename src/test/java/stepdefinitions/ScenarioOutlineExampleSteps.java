...
public class ScenarioOutlineExampleSteps {
    ...
    public void user_enters_first_name() {
        dataTablePage.firstname.sendKeys("Kenan");

    }

    @When("User enters last name")
    public void user_enters_last_name() {
        dataTablePage.lastname.sendKeys("Guzel");

    }

    @When("User enters position")
    public void user_enters_position() {
        dataTablePage.position.sendKeys("Tester");

    }

    @When("User enters office")
    public void user_enters_office() {
        dataTablePage.office.sendKeys("Bonn");

    }

    @When("User enters extension")
    public void user_enters_extension() {
        dataTablePage.extension.sendKeys("333");
    ...
    public void user_enters_first_name_to_the_searchbox() {
        dataTablePage.searchbox.sendKeys("Kenan");
    ...
    public void verify_that_user_see_the_first_name_in_the_searchbox() {
        ...
        Assert.assertTrue(name.contains("Kenan"));
    ...
    public void verify_that_user_see_the_first_name_in_the_searchbox(String string) {
        ...
        String name = dataTablePage.nameField.getText(); //1a
        Assert.assertTrue(name.contains(string)); // 1b
//                     1    =   2
//        Assert.assertTrue(dataTablePage.nameField.getText().contains(string)); // 2
